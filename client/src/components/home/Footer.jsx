...
<footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
        <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
            ...
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    ...
                    <li><span className="cursor-default">Blogs</span></li>
                    <li><span className="cursor-default">Community</span></li>
                    <li><span className="cursor-default flex items-center">Careers<span className="text-[10px] text-white bg-green-600 rounded-md ml-2 px-2 py-0.5 whitespace-nowrap">We’re hiring!</span></span></li>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
            ...
            <div className="flex items-center gap-4 mt-3">
                ...
                <a href="https://www.linkedin.com/in/yashpreet-gupta-b92a45369/" target="_blank" rel="noreferrer">
            ...
            <p className="mt-3 text-center">© 2026 Resumify. All Rights Reserved.</p>
        </div>
    </footer>
