    ...
    return (
        <>
            <div className="min-h-screen pb-20">
                {/* Navbar */}
                <nav className="z-50 flex items-center w-full py-5 px-6 md:px-16 lg:px-24 xl:px-40 text-lg font-medium">
                    ...
                    <div className="hidden md:flex items-center gap-10 transition duration-500 text-slate-800">
                        <a href="#features" className="hover:text-green-600 transition whitespace-nowrap">Features</a>
                        <a href="#testimonials" className="hover:text-green-600 transition whitespace-nowrap">Testimonials</a>
                        <a href="#faq" className="hover:text-green-600 transition whitespace-nowrap">FAQs</a>
                        <a href="#support" className="hover:text-green-600 transition whitespace-nowrap">Help</a>
                    </div>

                    <div className="flex-1 flex items-center justify-end gap-3">
                        {!user ? (
                            <>
                                <Link to='/app?state=register' className="hidden md:flex items-center justify-center px-8 py-2 bg-green-500 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white text-base font-semibold">
                                    Get started
                                </Link>
                                <Link to='/app?state=login' className="hidden md:flex items-center justify-center px-8 py-2 border border-slate-200 active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900 text-base font-semibold">
                                    Login
                                </Link>
                            </>
                        ) : (
                            <>
                                <Link to='/app' className='hidden md:flex items-center justify-center px-8 py-2 bg-green-500 hover:bg-green-700 active:scale-95 transition-all rounded-full text-white text-base font-semibold'>
                                    Dashboard
                                </Link>
                            </>
                        )}
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <a href="#support" className="text-white">Help</a>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex items-center">
                        <Link to='/app?state=register' className="bg-green-500 hover:bg-green-600 text-white rounded-full px-10 h-14 ring-offset-2 ring-1 ring-green-400 flex items-center justify-center transition-all hover:scale-105 active:scale-95 text-lg font-semibold shadow-lg shadow-green-200">
                            Get started
                    ...
                    <p className="py-6 text-slate-600 mt-14 text-lg font-medium">Our users have been hired at:</p>
